...
{
    public partial class FrmEditarPedidoPendiente : Form
    {
        Pedidos _owner;

        public FrmEditarPedidoPendiente()
        {
            InitializeComponent();
        }
        ...
        private void buttonGuardar_Click(object sender, EventArgs e)
        {
            ...
            try
            {
                ...
                if (this.dataGridViewProductos.Rows.Count > 0)
                {
                    ...
                    this.comboBoxEmpleados.Text, this.dateTimePickerFechaOrdenado.Text,
                    fecha_requerido, null, Convert.ToDecimal(this.textBoxCostoEnvio.Text));
